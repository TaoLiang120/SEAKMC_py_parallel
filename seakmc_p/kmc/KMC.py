...
from seakmc_p.input.Input import SP_COMPACT_HEADER, SP_KMC_HEADER, SP_DATA_HEADER
                            ...
                            if isp in thisBasin.localisp:
                                ...
                                if abs(thisbarr-self.bbarr)>=Tol4Barr: pass
                                    ...
                                    if maxdiff <= Tol4Disp:
                                        ...
                                        print(f"br:{br} br from last:{thisBasin.meanpref*np.exp(np.divide(-self.bbarr, KB*self.temp))}")
                                        print("+++++++++")
                                        '''
                            else: pass
                    potAVs[iav]=True
