...
from seakmc_p.input.Input import SP_COMPACT_HEADER, SP_COMPACT_HEADER4Delete, DEFECTBANK_ATOMS_HEADER, DEFECTBANK_DISPS_HEADER
from seakmc_p.input.Input import SP_DATA_HEADER, NDISPARRAY, SEQUENCE_DISPARRAY, NENTRY_COMPACT_DISP
