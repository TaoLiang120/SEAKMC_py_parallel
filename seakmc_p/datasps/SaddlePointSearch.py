...
from seakmc_p.core.util import mats_angle, sigmoid_function
from seakmc_p.spsearch.SPSearch import SPSearch, Dimer
...
def spsearch_search_single(nproc_task, thiscolor, comm_split, \
    ...
    if comm_split.Get_rank()==0: thisVN = generate_VN(thissett.spsearch, thisVNS, thisAVd.nactive, SNC=SNC, dmAV=dynmatAV)
    else: thisVN = None
