...
class VaspRunner(object):
    ...
    def run_runner(purpose, data, thiscolor, nactive = None, \
        ...
        if rank_local == 0:
            ...
            self.preparation(purpose, data, thiscolor, nactive=nactive, thisExports = thisExports, nproc = nproc_task, comm=comm)
        else:
            pass
